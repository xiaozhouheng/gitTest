...
function getReceivables(id){
	var id = id;
    var urls = "<%=path%>/page/updateJump.do?path=after/customsDeclaration/exportReceivables";
    var url = urls+"&id="+id; 
	layer.open({
    	  title: '收款页面',
    	  type: 2,
...
layui.use(['element','laydate'],function () {
    ...
    function getUploadFile(invoice,id){
    	var invoice = invoice;
    	var id = id;
        var urls = "<%=path%>/page/pageContract.do?path=after/customsDeclaration/exportUploadFile";
