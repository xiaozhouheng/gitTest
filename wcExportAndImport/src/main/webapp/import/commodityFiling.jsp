...
<body>
 <form method="post" enctype="multipart/form-data" 	action="<%=path%>/commodityFiling/importCommodityFiling.do">
		<div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">导入文件：</label>
                <div class="layui-input-inline">
                    <button type="button" class="layui-btn-blue" id="btnSubmit">
        ...
        <div class="layui-input-block btn-margin-left">
            <button class="layui-btn-blue" type="submit" id="uploadBtn">确定</button>
            <button onclick="window.close()" class="layui-btn-blue layui-btn-primary">取消</button>
        </div>
    	</div>
    	<!--导入进度条  -->
