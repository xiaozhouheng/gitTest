...
public class UserServiceImpl implements UserService{
	...
	@Autowired
	private CCorporateInformationMapper corporateInformationMapper;
	...
	@Override
	public int findCorporateByStatus() {
		...
		List<CCorporateInformation> list = corporateInformationMapper.selectByExample(example);
		return list.size();
	}
