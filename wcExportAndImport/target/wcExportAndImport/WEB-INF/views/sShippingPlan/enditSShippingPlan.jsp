...
function createTime(v){
    ...
    layui.use(['form', 'layedit', 'laydate', 'table', 'element','jquery'], function(){
    	 ...
    	 var modeOfTransport= Number($("#modeOfTransport").val());//运输方式
    	 ...
    	 var totalNumber= Number($("#totalNumber").val());//总件数
    	 var totalGrossWeight=$("#totalGrossWeight").val();//总毛重
    	 var totalCapacity=$("#totalCapacity").val();//总体积
    	 var packingType= Number($("#packingType").val());//包装种类
    	 var packageDimensions=$("#packageDimensions").val();//包装尺寸
    	 var supervisionType= Number($('#supervisionType').val());//监管方式
    	 var transactionTyep= Number($('#transactionTyep').val());//成交方式
    	 ...
    	 var mainWaybillNumberValue = mainWaybillNumber//mainWaybillNumberValue---定义用户输入的主运单号变量，mainWaybillNumber--为初始化的主运单号值，赋值给输入的变量是为了下方验证主运单号不为空使用。当验证条件为初始化主运单号时，用户修改主运单号时便不能验证是否为空。
		    	...
		    	table.render({
					...
					url:'<%=path%>/SShippingPlanDetails/getAllSShippingPlanDetails.do?sId='+'${sShippingPlan.id }',
		                page: false,
		                method:'get',
		                id: 'queryOrdersku',
		                 response: {
		    ...
		    $(function(){
		    	...
		    	$("select").change(function(){
		    	    ...
		    	    var modeOfTransportValue = Number($("#modeOfTransport").val());
		    	    var packingTypeName = $("#packingType").attr("name");
		    	    var packingTypeValue = Number($("#packingType").val());
		    	    var transactionTyepName = $("#transactionTyep").attr("name");
		    	    var transactionTyepValue = Number($("#transactionTyep").val());
		    	    var supervisionTypeName = $("#supervisionType").attr("name");
		    	    var supervisionTypeValue = Number($("#supervisionType").val());
		    	    var jsonGetSeleData ={
    	 ...
    	 laydate.render({
          ...
          //监听单元格（表体修改）编辑结束
				  ...
				  layer.open({
		        	   ...
		        	   cancel: function(){
		       			// 右上角关闭事件的逻辑
		        		   location.href = '<%=path%>/page/pageJump.do?path=views/sShippingPlan/SShippingPlanInopera';
		       		}
		        	 });
...
-->
	<!-- 双击弹出修改页面 -->	
	 <div id="orderMX" style="display: none; background-color: #F0F0F0;">
		...
		<input type="hidden" id="reviewId" name = "reviewId" value ="${sShippingPlan.reviewId }"class="form-control">
		<input type="hidden" id="status" name = "status" value ="${sShippingPlan.status }"class="form-control">
		<div class="col-lg-12 bighuan">
			<div class="col-lg-12 hang">
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<input type="text" id="destinationCountry" name = "destinationCountry" value ="${sShippingPlan.destinationCountry }"
							class="form-control">
					</div>
				</div>
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<input type="text" id="deliveryTime" name = "deliveryTime" value="<fmt:formatDate value="${sShippingPlan.deliveryTime}" pattern="yyyy-MM-dd"/>"
							class="form-control">
				...
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<select class="form-control category" name="modeOfTransport"
								...
								<option value="0" <c:if test="${sShippingPlan.modeOfTransport=='0'}">selected</c:if>>公路</option>
								<option value="1" <c:if test="${sShippingPlan.modeOfTransport=='1'}">selected</c:if>>铁路</option>
							</select>
					</div>
				</div>
				<%-- <div class="col-lg-3 saveInput">
				...
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<input type="text" id="destination" name = "destination" value ="${sShippingPlan.destination }"
							class="form-control">
					</div>
				</div>
			</div>
			<div class="col-lg-12 hang">
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<input type="text" id="exportPorts" name = "exportPorts" value ="${sShippingPlan.exportPorts }"
							class="form-control">
					</div>
				</div>
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<input type="text" id="mainWaybillNumber" name = "mainWaybillNumber" value ="${sShippingPlan.mainWaybillNumber }"
							class="form-control">
				...
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<input type="text" id="distributionOrderNumber" name = "distributionOrderNumber" value ="${sShippingPlan.distributionOrderNumber }"
							class="form-control">
					</div>
				</div>
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<input type="text" id="overseasConsignee" name = "overseasConsignee" value ="${sShippingPlan.overseasConsignee }"
							class="form-control">
					</div>
				</div>
			</div>
			<div class="col-lg-12 hang">
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<input type="text" id="domesticShipper" name = "domesticShipper" value ="${sShippingPlan.domesticShipper }"
							class="form-control">
					</div>
				</div>
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<input type="text" id="productionUnit" name = "productionUnit" value ="${sShippingPlan.productionUnit }"
							class="form-control">
					</div>
				</div>
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<input type="text" id="totalNumber" name = "totalNumber" value ="${sShippingPlan.totalNumber }"
							class="form-control">
					</div>
				</div>
				<%-- <div class="col-lg-3 saveInput">
				...
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<input type="text" id="totalGrossWeight" name = "totalGrossWeight" value ="${sShippingPlan.totalGrossWeight }"
							class="form-control">
					</div>
				</div>
			</div>
			<div class="col-lg-12 hang">
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<input type="text" id="totalCapacity" name = "totalCapacity" value ="${sShippingPlan.totalCapacity }"
							class="form-control">
					</div>
				</div>
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<%-- <input type="text" id="supervisionType" name = "supervisionType" value ="${aArrivalPlan.supervisionType }"
							...
							<select class="form-control category" name="packingType"
								id="packingType">
								<option value="">请选择</option>
								<option value="0" <c:if test="${sShippingPlan.packingType=='0'}">selected</c:if>>大包</option>
								<option value="1" <c:if test="${sShippingPlan.packingType=='1'}">selected</c:if>>小包</option>
							</select>
					</div>
				</div>
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<input type="text" id="freight" name = "freight" value ="${sShippingPlan.freight }"
							class="form-control">
					</div>
				</div>
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<input type="text" id="premium" name = "premium" value ="${sShippingPlan.premium }"
							class="form-control">
					</div>
				</div>
			</div>
					...
					<div class="col-lg-7 valueName">
						<%-- <input type="text" id="supervisionType" name = "supervisionType" value ="${aArrivalPlan.supervisionType }"
							...
							<select class="form-control category" name="transactionTyep"
								id="transactionTyep">
								<option value="">请选择</option>
								<%-- <option value="0" <c:if test="${sShippingPlan.transactionTyep=='0'}">selected</c:if>>方式三</option> --%>
								<option value="1" <c:if test="${sShippingPlan.transactionTyep=='1'}">selected</c:if>>CIF</option>
								<option value="2" <c:if test="${sShippingPlan.transactionTyep=='2'}">selected</c:if>>C&F</option>
								<option value="3" <c:if test="${sShippingPlan.transactionTyep=='3'}">selected</c:if>>FOB</option>
								<option value="4" <c:if test="${sShippingPlan.transactionTyep=='4'}">selected</c:if>>C&I</option>
								<option value="5" <c:if test="${sShippingPlan.transactionTyep=='5'}">selected</c:if>>市场价</option>
								<option value="6" <c:if test="${sShippingPlan.transactionTyep=='6'}">selected</c:if>>垫仓</option>
								<option value="7" <c:if test="${sShippingPlan.transactionTyep=='7'}">selected</c:if>>EXW</option>
							</select>
					</div>
				</div>
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<%-- <input type="text" id="supervisionType" name = "supervisionType" value ="${aArrivalPlan.supervisionType }"
							...
							<select class="form-control category" name="supervisionType"
								id="supervisionType">
								<option value="">请选择</option>
								<option value="0" <c:if test="${sShippingPlan.supervisionType=='0'}">selected</c:if>>方式一</option>
								<option value="1" <c:if test="${sShippingPlan.supervisionType=='1'}">selected</c:if>>方式二</option>
							</select>
					</div>
				</div>
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<input type="text" id="packageDimensions" name = "packageDimensions" value ="${sShippingPlan.packageDimensions }"
							class="form-control">
					</div>
				</div>
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<input type="text" id="businessNumber" name = "businessNumber" value ="${sShippingPlan.businessNumber }"
							class="form-control">
					</div>
				</div>
			</div>
			<div class="col-lg-12 hang">
				<div class="col-lg-3 saveInput">
					...
					<div class="col-lg-7 valueName">
						<input type="text" id="salespersonCode" name = "salespersonCode" value ="${sShippingPlan.salespersonCode }"
							class="form-control">
					</div>
				</div>
			</div>
			<%-- <div class="col-lg-12 hang">
				...
				<label class="col-lg-1 fieldName"><h9>上传附件:</h9></label>
					<!-- <div class="col-lg-7 valueName"> -->
						...
						<a href="javascript:;" class="file" position='relative'>装箱明细 <input type="file" name="file5" id="packingDetails" value="${aArrivalPlan.packingDetails }"></a>
						<a href="javascript:;" class="file" position='relative'>其他1  <input type="file" name="file6" id="other1" value="${aArrivalPlan.other1 }"></a>
						<a href="javascript:;" class="file" position='relative'>其他2 <input type="file" name="file7" id="other2" value="${aArrivalPlan.other2 }"></a>
