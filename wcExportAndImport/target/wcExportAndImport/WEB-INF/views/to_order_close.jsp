...
<html>
<head>
<title><spring:message code="toOrder.Closed" /></title>
<link rel="stylesheet"
...
<script type="text/javascript">
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element'], function(){
        ...
        table.render({
            elem: '#ordermanage',
            url:'<%=path%>/orderManage/findAll.do?notEnd=12',
            page: true,
            method:'post',
            height:600,
            limit:50,
	...
	<div class="xoms-thirdnavbar">
		<div class="container order-management-thirdnav">
			<ul class="nav nav-pills" style="margin-top: 30px;">
				...
				<li class="closed active"><a
					href="<%=path%>/orderManage/closed.html"> <span><i></i></span>
						<span><spring:message code="toOrder.Closed" />（${countVo.to_close}）<span
							class="nav-order-count"></span></span>
				</a></li>
		...
		<div
			...
			<div class="main">
				<div class="myorder-toolbar-container">
                 ...
                 <button class="btn info btn-sm min-screen-hidden disabled print"><span class="glyphicon glyphicon-print print"></span><spring:message code="toOrder.PrintLabel"/></button>
                 <div class="btn-group">
                     ...
                     <div class="form-group other-value-group">
                         ...
                         <button type="button" class="btn btn-default expand"><span class="glyphicon glyphicon-chevron-up expand"></span></button>
								...
								<input type="hidden" name="orderOutCustom.notEnd"
									class="form-control" value="5"> <input type="hidden"
