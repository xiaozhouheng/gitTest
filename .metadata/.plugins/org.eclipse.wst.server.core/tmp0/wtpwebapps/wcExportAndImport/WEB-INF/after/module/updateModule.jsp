    ...
    <form action="" method="post" id="enditform" class="layui-form enditform">
    	<div class="layui-form-item" style="display:none"><!--  -->
            ...
            <div class="layui-input-block">
                <input type="text"  class="layui-input" maxlength="20" name="parentId" id=""  value="${modular.parentId}">
            </div> 
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text"  class="layui-input" maxlength="20" name="name" id=""  value="${modular.name}">
            </div> 
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text"  class="layui-input" maxlength="20" name="code" id=""  value="${modular.code}" >
            </div> 
        </div>
...
layui.use('form', function(){
	...
	if("${modular.id}" != ""){
		...
		var url = "<%=path%>/modular/editModular.do"
	}
