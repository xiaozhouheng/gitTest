...
<html>
<head>
<title><spring:message code="toOrder.ShipmentReceived" /></title>
<link rel="stylesheet"
...
<script type="text/javascript">
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element'], function(){
        ...
        table.render({
            elem: '#ordermanage',
            url:'<%=path%>/orderManage/findAll.do?notEnd=1',
            page: true,
            method:'post',
            height:600,
            limit:50,
	...
	<div class="xoms-thirdnavbar">
		<div class="container order-management-thirdnav">
			<ul class="nav nav-pills" style="margin-top: 30px;">
				...
				<li class="handover active"><a
					href="<%=path%>/orderManage/ship.html"> <span><i></i></span> <span><spring:message
